	...
	<div id="wrap">
        ...
        <div id="content">
            ...
            <div class="center_content">
            	<div class="user_title_space">Edit User's Details</div>
                ...
                <div class="edit_details">
                	<div class="word">Full Name</div><div class="textfield"></div>
                    <div class="word">Mobile</div><div class="textfield"></div>
                    <div class="word">Email</div><div class="textfield"></div>
                    <div class="word">College</div><div class="textfield"></div>
                    <div class="word">Password</div><div class="textfield"></div>
                    <div class="word">Old Password</div><div class="textfield"></div>
                    <div class="word">New Password</div><div class="textfield"></div>
                    <div class="word">Confirm New Password</div><div class="textfield"></div>
                    
                    <button class="" type="button" title="Submit">Submit</button>
                </div>
            </div>
